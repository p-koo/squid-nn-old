...
**SQUID** (Surrogate Quantitative Interpretability for Deepnets) 
...
The documentation provided here is meant to help users quickly get SQUID working
 ...
 For more general correspondence, please contact Justin Kinney (`Email: jkinney@cshl.edu <jkinney@cshl.edu>`_, `Twitter: @jbkinney <https://twitter.com/jbkinney>`_)
 or Peter Koo  (`Email: koo@cshl.edu <jkinney@cshl.edu>`_, `Twitter: @pkoo562 <https://twitter.com/pkoo562>`_).
